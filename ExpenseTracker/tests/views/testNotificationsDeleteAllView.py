...
class DeleteAllNotificationViewTest(TestCase):
    ...
    # This test creates two read notifications for the user and checks that they 
    # are successfully deleted when the user clicks the "delete all" button. 
    # 
    # It also checks that an unread notification is not deleted, since it should be kept.
    ...
    # This test checks that the user is redirected to the notifications
    #  page after clicking the "delete all" button.
    ...
    # This test checks that an anonymous user is redirected to the login page 
    # if they try to access the "delete all" notifications page.
